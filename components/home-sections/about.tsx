...
export function AboutSection() {
    return (
        <section
            id="about"
            className="w-full section-padding py-20 lg:py-24 bg-background rounded-t-[48px] border-t border-x"
        >
...
function ProfileCard() {
    return (
        ...
        >
            ...
            <div className="relative aspect-5/6 w-full rounded overflow-hidden bg-gray-100 border border-black/5">
                <img
                    src={IMAGES.user}
                    alt="Obed Ovabor"
